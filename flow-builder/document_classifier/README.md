...
## Using Flow Agent with `docclassifier` Node from WxO Chat
...
4. Select the `document_classifier_agent` from the available agents.
5. Type a request such as "classify a document into custom classes". The agent will prompt you to upload the document.
